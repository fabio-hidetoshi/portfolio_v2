...
const experiences = [
  {
    ...
    description_pt: "Atuação em arquitetura de soluções, conectando sistemas e desenhando integrações.",
    description_en: "Working on solutions architecture, connecting systems and designing integrations.",
  ...
  },
  {
    company: "Echo AI",
    kind: "work",
    role_pt: "Desenvolvedor Back-End",
    role_en: "Back-End Developer",
    description_pt: "Desenvolvimento de features para o ECHO FIRST AI, implementando soluções de IA aplicada.",
    description_en: "Building features for ECHO FIRST AI, implementing applied AI solutions.",
    location: "São Paulo, Brasil",
  ...
  },
  {
    ...
    description_pt: "Formação técnica com foco em desenvolvimento de software.",
    description_en: "Technical education focused on software development.",
    location: "São Paulo, Brasil",
